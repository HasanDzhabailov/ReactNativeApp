...
export default class DotsLoading extends Component {
  ...
  render() {
    ...
    if (this.props.numberOfDots == 3) {
    } else if (this.props.numberOfDots == 2) {
      let dots = this._animation_state.dot_opacities.map((o, i) =>
        React.createElement(
          Animated.Text,
          {key: i, style: [this.props.style, {opacity: o}]},
    ...
    let dots1 = this._animation_state.dot_opacities.map((o, i) =>
      React.createElement(
        Animated.Text,
        {key: i, style: [this.props.style, {opacity: o}]},
        ' ',
    ...
    let dots2 = this._animation_state.dot_opacities.map((o, i) =>
      React.createElement(
        Animated.Text,
        {key: i, style: [this.props.style, {opacity: o}]},
        ' ',
