...
import globalStyles from '../Views/Style/globalStyles';
import {widthPercentageToDP as wp} from "react-native-responsive-screen";

export default class AnimatedCustome extends Component {
  constructor(props) {
    super(props);
...
AnimatedCustome.propTypes = {
  numberOfDots: PropTypes.number,
  animationDelay: PropTypes.number,
  minOpacity: PropTypes.number,
  style: Text.propTypes.style,
};
AnimatedCustome.defaultProps = {
  numberOfDots: 3,
  animationDelay: 300,
  minOpacity: 0,
  style: {
